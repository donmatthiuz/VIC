...
if __name__ == "__main__":
    ...
    # Si quieres probar con una imagen real, descomenta y especifica la ruta:
    # print("\n" + "="*50)
    # print("4. Pipeline completo con imagen real...")
    # ruta = "tu_imagen.jpg"  # Cambia por la ruta de tu imagen
    # magnitud_real, direccion_real = pipeline_completa(ruta)